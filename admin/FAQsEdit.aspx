<%@ Page Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="FAQsEdit.aspx.cs" Inherits="admin_FAQsEdit" Title="" Theme="Admin" %>
    ...
    <table border="0" cellpadding="3" cellspacing="0" width="100%">
        ...
        <tr>
            <td style="width: 150px">
                Answer:</td>
            <td>
                <FTB:FreeTextBox ID="txtAnswer" runat="server">
                </FTB:FreeTextBox>
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="btnEdit" runat="server" OnClick="btnEdit_Click" Text="Edit" ValidationGroup="FAQs" /></td>
        </tr>
    </table>
</asp:Content>
