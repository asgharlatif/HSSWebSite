<%@ Page AutoEventWireup="true" CodeFile="SubscriberAdd.aspx.cs" Inherits="admin_SubscriberAdd"
    ...
    <table border="0" cellpadding="3" cellspacing="0" width="100%">
        <tr>
            <td style="width: 150px">
                Group:</td>
            <td>
                <asp:DropDownList ID="ddlGroup" runat="server" Width="202px"></asp:DropDownList>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtEmail"
                    ...
                    ValidationGroup="Subscriber"></asp:RegularExpressionValidator></td>
        </tr>
         <tr>
            <td style="width: 150px">
                Name:</td>
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="btnAdd" runat="server" OnClick="btnAdd_Click" Text="Add" ValidationGroup="Subscriber" /></td>
        </tr>
    </table>
</asp:Content>
