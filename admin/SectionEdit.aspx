<%@ Page Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="SectionEdit.aspx.cs" Inherits="admin_SectionEdit" Title="" Theme="Admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPAdminBody" Runat="Server">
    ...
    <table border="0" cellpadding="3" cellspacing="0" width="100%">
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="btnEdit" runat="server" OnClick="btnEdit_Click" Text="Edit" ValidationGroup="Sections" /></td>
        </tr>
    </table>
</asp:Content>
